    ...
    <div className="flex min-h-screen bg-white text-slate-600 font-sans">
      ...
      <div className="w-full lg:w-[460px] min-w-[320px] flex items-center justify-center p-6 md:p-12 relative">
        <div className="w-full max-w-[380px]">
          ...
          <h1 className="text-2xl font-semibold text-slate-700 mb-1">Mulai Petualangan! 🚀</h1>
          <p className="text-sm text-slate-400 mb-8">Buat akun baru untuk memulai top-up</p>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="flex items-center justify-between mb-6 mt-4">
              <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer select-none">
                <input type="checkbox" className="w-4 h-4 text-purple-600 rounded border-slate-300 focus:ring-purple-500" required />
                <span>Saya setuju dengan <a href="#" className="text-purple-600 hover:text-purple-700 font-medium">Syarat & Ketentuan</a></span>
              </label>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            Sudah punya akun? <Link to="/login" className="font-medium text-purple-600 hover:text-purple-700 transition">Masuk</Link>
          </div>
